...
//    $db_name = "binaqfcu_binanceVest-db";
    ...
    if(isset($_POST["email"]) && (!empty($_POST["email"]))){
      ...
      if (!$email) {
         ...
         $sel_query = "SELECT * FROM `create_acc` WHERE email_id='".$email."'";
      ...
      $output.='<p>-------------------------------------------------------------</p>';
      $output.='<p><a href="https://www.binancevest.com/reset-password.php?
      key='.$key.'&email='.$email.'&action=reset" target="_blank">
      https://www.binancevest.com/reset-password.php
      ...
      $output.='<p>Thanks,</p>';
      $output.='<p>BinanceVest Team</p>';
      $body = $output; 
      $subject = "Password Recovery - BinanceVest.com";
   ...
   <div class="body" style="z-index: 1;">
      ...
      <div class="login-container">
         ...
         <form action=" " method="post" onSubmit="return validatePassword()">
            ...
            <!--</div>-->
            <input type="submit" value="Reset Password" class="full-width">
         </form>
      </div>
