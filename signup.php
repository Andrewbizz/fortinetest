      ...
      <div class="the-affiliate">
         ...
         <div class="body" style="z-index: 1;">
            ...
            <div class="login-container">
               <div class=" " style="color: #ee0909 !important; margin-bottom: 0px !important; padding-bottom: 0px !important; font-size: 23px; font-weight: bold !important; padding: 0 !important; font-family: poppins, sans-serif;">Let's Create Magic</div>
               <p class=" " style="color: rgb(0, 0, 0) !important; margin-bottom: 50px; margin-top: 0px !important;">Welcome to the future of Finance & Investments </p>
               <form action="signup-render.php" method="POST">
...
<div>
                  ...
                  <div class="input-div-half">
                     <div style="width: 100%;">
                        <!--h5>  Username</h5-->
                        <input placeholder="Email" required class="input" type="text" id="email" name="inputemail" />
                     </div>
                  </div>
                  ...
                  <div class="input-div-half">
                        ...
                        <div>
                           <!--h5>  password</h5-->
                           <input placeholder="Password" required class="input" type="password" id="password" name="passwrd" />
                        </div>
                  ...
                  <div class="input-div-half">
                    <div style="width: 100%;">
                       <!--h5>  Username</h5-->
                       <input placeholder="Repeat password" required class="input" type="text" id="repeat" name="confm_passwrd" />
                    </div>
                 </div>
                 ...
                 <div class="input-div-half">
                       ...
                       <div>
                          <!--h5>  password</h5-->
                          <input placeholder="Phone number" required class="input" type="password" id="password" name="phone" />
                       </div>
                    ...
                    <div class="input-div-half">
                       ...
                       <div>
                          <!--h5>  password</h5-->
                          <input placeholder="Wallet Address" required class="input" type="wallet" id="wallet" name="walletid" />
                       </div>
                  ...
                  <!--</div>-->
                  <input required type="submit" class="sub-btn" onclick="login()" name="register_user" value="Sign Up">
